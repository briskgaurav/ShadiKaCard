  ...
  return (
    <div className="min-h-[200vh]  w-full h-fit max-md:h-[300vh] relative">
      ...
      <div className="h-full w-full gap-[2vw] overflow-x-hidden max-md:gap-[10vw] py-[10vw] max-md:absolute max-md:top-[-4%] left-0 flex items-center justify-center flex-col relative ">
        ...
        <div className="h-auto w-[7vw] max-md:w-[20vw] rounded-full aspect-square relative">
          <img
        ...
        <div className="w-[80%] flex items-center gap-[4vw] max-md:gap-[15vw] max-md:flex-col justify-center mt-[5vw]">
          ...
          {[
            ...
            { icon: "/img/sun.avif", title: "Hashtag", description: "Use #thebestmarathon to share your journey runners." },
            { icon: "/img/card.avif", title: "Hashtag", description: "Use #thebestmarathon to share your journey runners." },
            { icon: "/img/parking.avif", title: "Hashtag", description: "Use #thebestmarathon to share your journey runners." },
          ].map((item, index) => (
