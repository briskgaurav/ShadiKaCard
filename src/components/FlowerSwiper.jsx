...
export default function FlowerSwiper() {
  ...
  return (
    <div className="h-[63vw] max-md:h-[100vw] w-auto aspect-square py-[5vw] max-md:py-[10vw] relative">
      ...
      <div className="h-[29.2vw] w-auto aspect-square max-md:w-[62.5vw] max-md:h-auto rounded-full overflow-hidden swiperimages z-2 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
