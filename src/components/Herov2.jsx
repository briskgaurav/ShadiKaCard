          ...
          <div className="w-full h-full relative">
            <div className="w-[50vw] max-md:w-screen font-bizantheum text-[9vw] max-md:text-[18vw] text-center leading-[1.2] flex items-center max-md:items-center max-md:px-[8vw] justify-between  max-md:justify-start max-md:mt-[30vw] pb-[16vw] pt-[16vw] max-md:pt-[5vw] flex-col text-primary h-full">
              ...
              <div className="">
                <h1 className="">
                  <CopyLines delay={4.5}>
                  <span className="inline-block">{name1}</span>
                  </CopyLines>
                  <CopyLines delay={4.5}>
                <span className="text-[5vw] max-md:text-[10vw] leading-normal block">Weds</span>
                </CopyLines>
                <CopyLines delay={4.5}>
                <span className="max-md:mt-[-3vw] inline-block">{name2}</span>
                </CopyLines>
                </h1>
              </div>
