      ...
      <div className=" w-full flex items-center justify-center relative  max-md:py-[20vw] max-md:pb-[10vw] max-md:h-fit">
        <div className="flex flex-col space-y-[1vw] max-md:space-y-[6vw] text-[#a20601] font-serif items-center justify-center w-full">
          ...
          <CopyLines>
            ...
            <p className="w-[58%] font-semibold max-md:w-[90%] text-center content2 max-md:text-[4.5vw] tracking-wider leading-[1.2] max-md:font-medium mt-[-1.5vw]">
          ...
          <p className="content2 font-semibold  max-md:text-[4.5vw] leading-[1.2] max-md:leading-[1.4] text-center w-[72%] max-md:w-[80%]  mt-[2vw] max-md:mt-[6vw]">
          ...
          <p className="content2 max-md:text-[3.5vw] font-georgia text-center w-[60%] max-md:w-full font-medium mt-[2vw] max-md:mt-[8vw]">
