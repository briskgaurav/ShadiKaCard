    ...
    <div className="min-h-[160vh] max-md:min-h-[130vh] max-md:justify-end max-md:pb-[15vh] flex flex-col py-[5vw] items-center justify-between w-full relative">
      ...
      <div className="h-fit w-full flex items-center justify-center relative">
        <div className="flex flex-col space-y-[2vw] max-md:space-y-[5vw] text-[#a20601] font-serif items-center justify-center w-[50%] max-md:w-[90%]">
          <CopyLines>
            <p className="text40 w-[100%] max-md:w-[100%] font-cormorant-upright leading-[1.2] text-center mt-[-5vw] max-md:mt-[20vh] max-md:!text-5xl">
              The countdown begins
            </p>
            <DynamicCounter />
          </CopyLines>
          <CopyLines>
            <p className="text30 leading-[1.2] font-cormorant-upright text-center w-[80%] max-md:w-full font-medium mt-[5vw] max-md:!text-2xl">
          ...
          <div className="flex items-center justify-between max-md:justify-center w-[60%] max-md:w-[90%] font-cormorant-upright gap-[2vw] max-md:gap-[10vw] text30 my-[2vw] max-md:my-[5vw] max-md:!text-xl">
