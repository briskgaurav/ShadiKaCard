...
export default function RotationComponent({
  ...
  return (
    ...
    >
      ...
      >
        <Copy>
          <p className="text-[1.9vw] max-md:text-[5vw]! font-notoserif-italic italic leading-[1.2]">
            {title} <br/> {titleLine2}
          </p>
        </Copy>
        <div className="flex flex-col items-center  gap-y-[1vw] content">
       
            <HoverLineComponent text={subtitle} className={"text-[2vw]! mt-[1vw] max-md:mt-[2vw] leading-[1.2]"} href={"https://maps.app.goo.gl/82WrR8ZVf1K6SAhS6"} lineColor={textColor} target={"_blank"} />
